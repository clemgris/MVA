...
def online_face_recognition_updated(profile_names,
                                    IncrementalKCenters,
                                    n_pictures=15,
                                    path_unknown_save="C:/Users/cgris/OneDrive/Documents/ENPC/4A 2022-2023/S2/GRAPH IN ML/semi_supervised_learning/data/unknown",
                                    video_filename=None):
    """
    Run online face recognition.
    ...
    while True:
        ...
        for b0 in box:
            ...
            if labels[0] == "unknown":
                ...
                image_name = os.path.join(path_unknown_save, "unknown_" + str(image_count) + ".bmp")
                img_to_save = x_t
                cv.imwrite(image_name, img_to_save)
                print("Unknown image", image_count, "saved at", image_name)
